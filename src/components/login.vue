<template>
	<div class="content bg-gray-800 p-5 w-103 rounded-md">
		<div class="logo">
			<img
				class="w-24"
		...
		<div class="link flex justify-center">
			<div
				class="link_items border-0.1 p-2 rounded border-gray-500 mx-2 flex items-center cursor-pointer"
			...
			>
				...
				<span class="text-gray-400 font-medium text-sm">{{ item.name }}</span>
			</div>
		</div>
