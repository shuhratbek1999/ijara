<template>
	<div class="users">
		<ul class="border-2 p-5">
			<li v-for="(item, index) in users" :key="index" class="m-2">
				<div class="name w-1/2 border-2 flex justify-between p-2">
					<h4>name:</h4>
					<h2>{{ item.name }}</h2>
				</div>
				<div class="email w-1/2 border-2 flex justify-between my-4 p-2">
					<h4>email:</h4>
					<h2>{{ item.email }}</h2>
				</div>
				<div class="role w-1/2 border-2 flex justify-between p-2">
					<h4>role:</h4>
					<h2>{{ item.role }}</h2>
				</div>
			</li>
